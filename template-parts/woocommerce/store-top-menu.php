                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        if (!is_user_logged_in()) {
                            ...
                            <span class="login-navbar"><a href="/login-user"><i class=" login-nav-icon fa fa-sign-in hidden-sm hidden-lg hidden-md"></i> </a></span>
                            <!-- FIXED IN TIVA V5.5.2-->
                                    ...
                                    <li class="dropdown dropdown-user">
                                        <a href="javascript:;" class="dropdown-toggle user-name-link"
                                           ...
                                           data-close-others="true">
                                            <img alt="" class="user_avatar_login_menu"
                    ...
                    <?php if (has_nav_menu('tiva_store_header_main_menu')): ?>
                        <?php
                        wp_nav_menu(array(
                                'menu' => 'tiva_store_header_main_menu',
                                'theme_location' => 'tiva_store_header_main_menu',
                                'depth' => 5,
                                'container' => 'div',
        ...
        <div class="col-xs-12 col-md-3 hidden-xs hidden-sm">
            ...
            if (karino_get_msg_no_read_count_home_page(get_current_user_id()) > '0'):
                ...
                <div class="msg-icon-wrraper">
                    <a href="<?php echo home_url() . '/user-panel/all-msg-received'; ?>">
            ...
            <div class="left-login-area hidden-sm">
                ...
                if (!is_user_logged_in()) {
                    ?>
                    <a href="  <?php echo site_url() . '/register-user' ?>" class="register-btn">
                        <i class="fa fa-user-plus" aria-hidden="true"></i>عضویت
                    </a>
                    <a href="<?php echo site_url() . '/login-user' ?>" class="login-btn">
