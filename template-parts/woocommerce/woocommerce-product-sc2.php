...
(isset($tiva_options['store-index-page']['box-cat-2'])) ? $boxCat2 = get_term((int)$tiva_options['store-index-page']['box-cat-2']) : $boxCat2 = '';
$all_product_args = array(
    'product_cat' => $boxCat2->slug,
    'post_type' => 'product',
    'orderby' => 'date',
    'order' => 'DESC',
    'posts_per_page' => 10
...
if ($all_new_product->have_posts()): ?>
    <div class=" product-wrapper related-video-wrapper">
        ...
        <header class="box-header">
            <span class="post-title"><?php echo $boxCat2->name ?></span>
            <span class="video-archive-link">
                        <a href="<?php echo get_category_link($boxCat2->term_id); ?>">+ مشاهده همه</a>
                    </span>
        </header>
...
<?php else : ?>
    <div class="product-wrapper card-wrapper">
        ...
        <header>
            <span class="product-title"><?php echo $boxCat2->name ?></span>
        </header>
        <div class="no-post">
