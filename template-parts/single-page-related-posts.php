            ...
            <article>
                <a href="<?php echo get_the_permalink($related_post->ID); ?>"
                   title="<?php echo get_the_title($related_post->ID); ?>">
                    <img class="related-post-pic" src="<?php echo get_the_post_thumbnail_url($related_post->ID, 'tiva-related-post-thum'); ?>" title="<?php echo get_the_title($related_post->ID); ?>"  alt="<?php echo get_the_permalink($related_post->ID); ?>">
