...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<span><?php _e( 'تراکنش های بانکی کاربران', 'tiva' ); ?></span>
		</li>
	</ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e( 'گزارش تراکنش های بانکی کاربران', 'tiva' ); ?>
	<small><?php _e( 'نمایش تمام گزارش تراکنش های بانکی کاربران', 'tiva' ); ?></small>
</h1>
<!-- END PAGE TITLE-->
<br>
<div class="row">
	<div class="note note-info">
		...
		<p>مدیر محترم شما می توانید از طریق این لیست ، تراکنش های بانکی کاربران را بررسی و پیگیری کنید.</p>
	</div>
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-red-sunglo">
					...
					<span class="caption-subject bold uppercase"><?php _e( 'لیست گزارش تراکنش های بانکی کاربران', 'tiva' ) ?></span>
				</div>
				<div class="tools"></div>
			</div>
			<div class="portlet-body">
				<table class="table table-striped table-bordered table-hover" id="sample_1">
					...
					//					dd($current_user);
					$result = $wpdb->get_results( "SELECT * FROM {$tiva_pay_handel} " );
					//					dd( $result );
