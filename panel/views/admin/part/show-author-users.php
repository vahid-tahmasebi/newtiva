...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('کاربران نویسنده', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e(' کاربران نویسنده', 'tiva'); ?>
    <small><?php _e('نمایش کاربران با نقش نویسنده در سایت شما ', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
    <div class="col-md-12">
                                        ...
                                        <div class="mt-card-avatar mt-overlay-1 ">
                                            ...
                                            <div class="mt-overlay">
                                                <ul class="mt-info">
                                                    ...
                                                    <li>
                                                        <a class="btn default btn-outline" href="<?php echo get_author_posts_url($user->ID) ?>" data-toggle="tooltip" title="آرشیو مطالب"><i class="fa fa-link user-icon-overlay"></i>
                                                        </a>
                                                    </li>
                                                    <li>
