...
<h1 class="page-title"><?php _e( 'تیکت ها', 'tiva' ); ?>
    <small><?php _e( 'نمایش تمام تیکت های ثبت شده توسط کاربران در سیستم پشتیبانی ', 'tiva' ); ?></small>
</h1>
<!-- END PAGE TITLE-->
<br>
<div class="row">
    <div class="note note-info">
        ...
        <p>شما می توانید از طریق لیست زیر تیکت های ارسالی کاربران را مدیریت و بررسی کنید.</p>
    </div>
</div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"><?php _e( 'تمام تیکت های ارسالی کاربران', 'tiva' ) ?></span>
                </div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_1">
					...
					//					dd($current_user);
					$result = $wpdb->get_results( "SELECT * FROM {$tiva_tickets} ORDER BY ticket_create_at DESC" );
					//					dd( $result );
					foreach ( $result as $print ) {


						$date1 = new DateTime($print->ticket_create_at) ;
//						var_dump($date1);
						$date2 =  new DateTime($print->ticket_update_at)  ;
...
//					    var_dump($print);
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo wp_nonce_url( add_query_arg( array( 'ticket_id' => $print->ticket_id ), site_url().'/admin-panel/show-ticket' ) ) ?>" class="btn btn-outline btn-circle red btn-sm blue"><i class="fa fa-share"></i> نمایش</a>
                            </td>
                        </tr>
						<?php
					}
