...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('پیام های ارسالی شما', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('پیام های ارسالی شما', 'tiva'); ?>
    <small><?php _e('نمایش تمام پیام های ارسالی شما', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"><?php _e('لیست پیام های ارسالی شما', 'tiva') ?></span>
                </div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    $result = $wpdb->get_results("SELECT * FROM {$tiva_msg_table} WHERE `admin_id`={$current_admin}");
