...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('کاربران بلاک شده', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e(' کاربران بلاک شده', 'tiva'); ?>
    <small><?php _e('نمایش تمام کاربران بلاک شده در سایت شما', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
    <div class="col-md-12">
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">لیست کاربران نویسنده</span>
                </div>
            </div>
...
//                        var_dump($all_user);
                        ...
                        if (!empty($user_query->results)) {
                                    ...
                                    <div class="mt-card-item">
                                        ...
                                        <div class="mt-card-avatar mt-overlay-1 ">
                                            ...
                                            <div class="mt-overlay">
                                                <ul class="mt-info">
                                                    <li>
                                                        <a class="btn default btn-outline karino_user_unblock"
                                                           data-id="<?php echo $user->ID; ?>" data-toggle="tooltip"
                                                           title="فعال کن">
                                                            <i class="fa fa-unlock user-icon-overlay"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                            ...
                            $html .= '</h4>';
                            $html .= '<p>';
                            $html .= ' مدیر محترم ! کاربر بلاک شده ای در سایت یافت نشد. ';
                            $html .= '</p>';
                            $html .= '</div>';
                            echo $html;
                        }
