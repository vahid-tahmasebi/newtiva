...
$all_comments_approved = tiva_get_user_comment_count($current_user->ID,'0');
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <button data-id="<?php echo get_comment_ID(); ?>" type="submit" name="comment-edit" class="btn btn-default green save-edit-comment" data-dismiss="modal"><?php _e('ذخیره تغییرات', 'tiva'); ?></button>
...
<?php else : ?>
    ...
    $html .= '</h4>';
    $html .= '<p>';
    $html .= 'کاربر گرامی دیدگاهی از طرف شما در انتظار بررسی نیست.';
    $html .= '</p>';
    $html .= '</div>';
    echo $html;
     ?>
