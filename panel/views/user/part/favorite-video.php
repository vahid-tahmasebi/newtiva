...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('ویدیوها', 'tiva'); ?>
    <small><?php _e('نمایش ویدیوهای ذخیره شده در علاقه مندی های شما ', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
    <div class="main-content">
        <?php include SL_THEME_USER_PANEL_VIEWS . '/user/all_video_favorite_loop_query.php'; ?>
    </div>
</div>
