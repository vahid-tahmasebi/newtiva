...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('حذف شده ها توسط من ', 'tiva'); ?></span>
        </li>
    </ul>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase"><?php _e('مدیریت دیدگاه های حذف شده توسط من ', 'tiva'); ?></span>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="portlet_comments_1">
                        ...
                        <div class="mt-comments">
                            <?php
                            include SL_THEME_USER_PANEL_VIEWS . '/user/all_comments_query_user_trash.php';
                            ?>
                        </div>
                        <!-- END: Comments -->
                    </div>
