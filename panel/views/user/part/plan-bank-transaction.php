...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('گزارش تراکنش های مالی ', 'tiva'); ?></span>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span><?php _e('گزارش پرداخت آنلاین عضویت ویژه', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('تراکنش های بانکی خرید پلن های عضویت ویژه', 'tiva'); ?>
    <small><?php _e('نمایش تمام تراکنش های بانکی خرید پلن های عضویت ویژه', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<br>
<div class="row">
    <div class="note note-info">
        ...
        <p>کاربر محترم شما می توانید از این طریق تراکنش های بانکی خرید پلن های عضویت ویژه خود را بررسی و پیگیری کنید. </p>
    </div>
</div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"><?php _e('لیست تراکنش های بانکی خرید پلن های عضویت ویژه', 'tiva') ?></span>
                </div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    //					dd($current_user);
                    $result = $wpdb->get_results("SELECT * FROM {$tiva_pay_handel} where user_id={$current_user} and type=4");
                    //					dd( $result );
