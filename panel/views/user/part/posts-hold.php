...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('نمایش در انتظار بررسی ها', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('نمایش مطالب', 'tiva'); ?>
    <small><?php _e('نمایش مطالب ارسالی شما', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->

<div class="row">
    <div class="main-content">
        <?php include SL_THEME_USER_PANEL_VIEWS . '/user/all_post_user_hold_loop_query.php'; ?>
    </div>
</div>
