...
global $wpdb, $table_prefix, $replyOk;
...
//				    send email for user
    ...
    $ticket_item = $wpdb->get_row($wpdb->prepare("
        ...
        WHERE ticket_user_id=%d AND ticket_id = %d
...
//    dd($replyOk);
    if ($replyOk == true) {
        $to = get_userdata($ticket_item->ticket_supporter_id)->user_email;
        $subject = get_bloginfo('name') . ' | پاسخ جدید برای شما ';
        $message = tiva_user_send_reply_ticket_email_temp($operatorDispalyName = get_userdata($ticket_item->ticket_supporter_id)->display_name, $userDispalyName = get_userdata(get_current_user_id())->display_name, $dateTime = jdate('d-m-Y H:i:s'));
        ...
        <div class="profile-sidebar">
            ...
            <div class="portlet light profile-sidebar-portlet">
                ...
                <div class="profile-userpic">
                    <img src="<?php echo esc_url(tiva_get_user_avatar((int)$ticket_item->ticket_supporter_id)); ?>"
                ...
                <div class="profile-usertitle">
                    ...
                    <div class="profile-usertitle-name"><?php echo get_userdata($ticket_item->ticket_supporter_id)->display_name ?></div>
                    <div class="profile-usertitle-job"><?php echo get_user_meta($ticket_item->ticket_supporter_id, 'unit_supporter', true) ?></div>
                </div>
            ...
            <div class="portlet light ">
                ...
                <div class="row list-separated profile-stat">
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="uppercase profile-stat-title"><?php echo tiva_change_number(tiva_get_user_comment_count($ticket_item->ticket_supporter_id, '1')); ?></div>
                        <div class="uppercase profile-stat-text"><?php _e('نظرات ', 'tiva'); ?></div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="uppercase profile-stat-title"><?php echo tiva_change_number(intval(tiva_get_user_score($ticket_item->ticket_supporter_id))); ?></div>
                        <div class="uppercase profile-stat-text"> <?php _e('امتیاز', 'tiva'); ?></div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="uppercase profile-stat-title"><?php echo tiva_change_number(count_user_posts($ticket_item->ticket_supporter_id)); ?></div>
                ...
                <div>
                    <h4 class="profile-desc-title"><?php _e('بیوگرافی', 'tiva');
                        echo "  ";
                        echo get_userdata($ticket_item->ticket_supporter_id)->display_name; ?></h4>
                    <span class="profile-desc-text"> <?php echo get_userdata($ticket_item->ticket_supporter_id)->description; ?> </span>
                    <div class="margin-top-20 profile-desc-link">
                        <?php echo tiva_get_supporter_social_network_icon('web', $ticket_item->ticket_supporter_id); ?>
                    </div>
                    <div class="margin-top-20 profile-desc-link">
                        <?php echo tiva_get_supporter_social_network_icon('telegram', $ticket_item->ticket_supporter_id); ?>
                    </div>
                    <div class="margin-top-20 profile-desc-link">
                        <?php echo tiva_get_supporter_social_network_icon('instagram', $ticket_item->ticket_supporter_id); ?>
                    </div>
                    <div class="margin-top-20 profile-desc-link">
                        <?php echo tiva_get_supporter_social_network_icon('linkedin', $ticket_item->ticket_supporter_id); ?>
                    </div>
                </div>
            </div>
            <!-- END PORTLET MAIN -->
