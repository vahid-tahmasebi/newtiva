...
global $wpdb, $table_prefix, $replayOk, $ticket_item;
...
//    var_dump($ticket_item);
    if (!is_null($ticket_item)) {
        if (intval($ticket_item->ticket_id) != intval($_GET['ticket_id'])) {
...
//var_dump($ticket_item);
if (intval($ticket_item->ticket_supporter_id) != get_current_user_id() || is_null($ticket_item)) {
