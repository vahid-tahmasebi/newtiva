...
if (isset($_POST['save_billing_address'])) {
    do_action('tiva_user_save_billing_address');
}
?>
<!-- BEGIN PAGE BAR -->
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('ویرایش آدرس صورت حساب', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('آدرس صورت حساب', 'tiva'); ?>
    <small><?php _e('ویرایش آدرس صورت حساب های شما', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase"><?php _e('آدرس صورت حساب', 'tiva'); ?></span>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active "
                                    ...
                                    <form method="post" role="form" action="" id="save_profile" name="account-edit">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_first_name', true); ?>"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('نام خانوادگی ', 'tiva'); ?><span
                                                        style="color: red">*</span></label>
                                            <input type="text"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_last_name', true); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"/></div>
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('تلفن', 'tiva'); ?><span
                                                        style="color: red">*</span></label>
                                            <input type="number"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_phone', true) ?>"
                                                   name="billing_phone"
                                                   placeholder="<?php _e('شماره فعال همراه خود را وارد کنید', 'tiva'); ?>"
                                                   class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('آدرس ایمیل شما', 'tiva'); ?> <span
                                                        style="color: red">*</span></label>
                                            <input name="billing_email" required maxlength="70" type="text"
                                                   placeholder="آدرس ایمیل خودرا وارد کنید"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_email', true) ?>"
                                                   class="form-control"/></div>
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('کشور', 'tiva'); ?><span
                                                        style="color: red">*</span></label>
                                            <select name="billing_country" class="form-control">
                                                ...
                                                foreach ($countries as $key => $value):?>
                                                    <option value="<?php echo $key; ?>" <?php echo (get_user_meta($current_user_id, 'billing_country', true) == $key) ? 'selected' : '' ?>><?php echo $value; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input name="billing_state" type="text"
                                                   ...
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_state', true); ?>"
                                                   class="form-control"/></div>
                                        <div class="form-group">
                                            ...
                                            <input name="billing_city" type="text"
                                                   ...
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_city', true); ?>"
                                                   class="form-control"/></div>
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('خیابان', 'tiva'); ?><span
                                                        style="color: red">*</span></label>
                                            <input name="billing_address_1" type="text"
                                                   placeholder="پلاک خانه و نام خیابان مورد نظر خود را وارد کنید"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_address_1', true); ?>"
                                                   class="form-control"/>
                                            <br>
                                            <input name="billing_address_2" type="text"
                                                   placeholder="شماره واحد ، بلوک مورد نظر خود را وارد کنید"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_address_2', true); ?>"
                                                   class="form-control"/>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label"><?php _e('کد پستی', 'tiva'); ?><span
                                                        style="color: red">*</span></label>
                                            <input type="number"
                                                   value="<?php echo get_user_meta($current_user_id, 'billing_postcode', true) ?>"
                                        ...
                                        <div class="margiv-top-10">
                                            <button type="submit" class="btn green" name="save_billing_address"> ذخیره
                                                تغییرات
                                            </button>
                                        </div>
                                    </form>
