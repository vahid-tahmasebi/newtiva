...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('مطالب دانلودی', 'tiva'); ?></span>
        </li>
    </ul>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?php _e('مطالب دانلودی', 'tiva'); ?>
    <small><?php _e('نمایش مطالب دانلودی ذخیره شده در علاقه مندی های شما ', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
    <div class="main-content">
        <?php include SL_THEME_USER_PANEL_VIEWS . '/user/all_download_favorite_loop_query.php'; ?>
    </div>
</div>
