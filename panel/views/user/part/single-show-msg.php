...
$msg_action = $_GET['view'];
karino_read_msg_set_data($msg_id, get_current_user_id());
?>
...
<h1 class="page-title"><?php _e('مدیریت پیام ها', 'tiva'); ?>
    <small><?php _e('نمایش پیام دریافتی', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<div class="row">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" role="form" action="" id="send_msg" name="send_msg">
                    ...
                    <br>
                    <br>
                    <?php if(!empty(karino_get_msg($msg_id, 'msg_att'))): ?>
                    <div class="form-group text-center">
                        <a href="<?php echo karino_get_msg($msg_id, 'msg_att'); ?>" class="btn red ">
                            <i class="fa fa-paperclip"></i>برای دانلود فایل پیوست شده به پیام کلیک کنید
                        </a>
                    </div>
                    <?php endif; ?>
                </form>
