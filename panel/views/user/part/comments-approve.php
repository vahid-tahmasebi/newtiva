...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php _e('تایید شده ها', 'tiva'); ?></span>
        </li>
    </ul>
...
<h1 class="page-title"><?php _e('مدیریت دیدگاه ها', 'tiva'); ?>
    <small><?php _e('نمایش دیدگاه های تاییده شده شما در سایت ', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase"><?php _e('مدیریت دیدگاه های تایید شده شما ', 'tiva'); ?></span>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="portlet_comments_1">
                        ...
                        <div class="mt-comments">
                            <?php
                            include SL_THEME_USER_PANEL_VIEWS . '/user/all_comments_query_approve.php';
                            ?>
                        </div>
                        <!-- END: Comments -->
                    </div>
