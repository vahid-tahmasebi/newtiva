...
<h1 class="page-title"><?php _e('تیکت ها', 'tiva'); ?>
    <small><?php _e('نمایش تمام تیکت های ارسال شده برای شما در سایت', 'tiva'); ?></small>
</h1>
<!-- END PAGE TITLE-->
<br>
<div class="row">
    <div class="note note-info">
        ...
        <p>شما می توانید از طریق لیست زیر تیکت های ارسالی برای شما را مدیریت و بررسی کنید.</p>
    </div>
</div>
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    //					dd($current_user);
                    $result = $wpdb->get_results("SELECT * FROM {$tiva_tickets} where ticket_supporter_id={$current_user} ORDER BY ticket_create_at DESC");
                    //					dd( $result );
...
//						var_dump( $diff->days );
//                        var_dump($print->ticket_supporter_id);
                        ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo wp_nonce_url(add_query_arg(array('ticket_id' => $print->ticket_id), site_url().'/user-panel/supporter-show-ticket')) ?>"
