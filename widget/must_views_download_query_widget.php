...
class tiva_must_views_download_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_must_views_download_widget', // Base ID
            ' ابزارک پر دانلود ترین مطالب دانلودی تیوا', // Name
            array('description' => __('نمایش پر دانلود ترین  مطالب دانلودی منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('پربازدیدترین مطالب دانلودی', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_must_views_download_widget');
});