...
class tiva_count_views_download_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_count_views_download_widget', // Base ID
            'پر دانلودترین مطالب دانلودی تیوا', // Name
            array('description' => __(' ابزارک نمایش مطالب دانلودی که بیشترین دانلود را داشته اند', 'text_domain'),) // Args
        );
    }
...
add_action('widgets_init', function () {
    register_widget('tiva_count_views_download_widget');
});