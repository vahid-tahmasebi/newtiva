<?php
// ******************* ADD IN TIVA V4 ********************
class tiva_must_views_post_in_mon_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_must_views_post_in_mon_widget', // Base ID
            ' ابزارک برترین مقاله های ماه تیوا', // Name
            array('description' => __('نمایش  برترین مقاله های ماه منتشر شده در سایت', 'tiva'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('برترین مقاله های ماه', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_must_views_post_in_mon_widget');
});