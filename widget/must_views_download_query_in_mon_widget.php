...
class tiva_must_views_download_in_mon_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_must_views_download_in_mon_widget', // Base ID
            ' ابزارک برترین مطالب دانلودی ماه در تیوا', // Name
            array('description' => __('نمایش برترین مطالب دانلودی ماه منتشر شده در سایت', 'tiva'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('برترین مطالب دانلودی ماه ', 'tiva');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_must_views_download_in_mon_widget');
});