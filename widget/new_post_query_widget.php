...
class tiva_new_post_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_new_post_widget', // Base ID
            'ابزارک جدیدترین مقاله های تیوا', // Name
            array('description' => __('نمایش جدیدترین مقاله های منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
add_action('widgets_init', function () {
    register_widget('tiva_new_post_widget');
});