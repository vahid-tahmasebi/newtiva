...
class tiva_hot_download_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_hot_download_widget', // Base ID
            ' ابزارک داغ ترین مطالب دانلودی تیوا', // Name
            array('description' => __('نمایش داغ ترین  مطالب دانلودی منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('داغ ترین مطالب دانلودی', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_hot_download_widget');
});

//hot_download_query_widget.php