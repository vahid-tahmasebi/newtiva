...
class tiva_must_views_post_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_must_views_post_widget', // Base ID
            ' ابزارک پر بازدید ترین مقاله های تیوا', // Name
            array('description' => __('نمایش پر بازید ترین  مقاله های منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('پربازدیدترین مقاله ها', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_must_views_post_widget');
});