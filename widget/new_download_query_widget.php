...
class tiva_new_download_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_new_download_widget', // Base ID
            'ابزارک جدیدترین مطالب دانلودی تیوا', // Name
            array('description' => __('نمایش جدیدترین مطالب دانلودی منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('جدیدترین  مطالب دانلودی', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_new_download_widget');
});