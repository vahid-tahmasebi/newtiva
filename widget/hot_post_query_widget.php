...
class tiva_hot_post_widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'tiva_hot_post_widget', // Base ID
            ' ابزارک داغ ترین مقاله های تیوا', // Name
            array('description' => __('نمایش داغ ترین  مقاله های منتشر شده در سایت', 'text_domain'),) // Args
        );
    }
...
//        var_dump($instance);
        if (isset($instance['title'])) {
            ...
            $title = __('داغ ترین مقاله ها', 'text_domain');
        }
...
add_action('widgets_init', function () {
    register_widget('tiva_hot_post_widget');
});